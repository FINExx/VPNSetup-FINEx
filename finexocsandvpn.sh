...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master"
else
	source="https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master"
fi
...
read -p "Password: " -e -i panda29 DatabasePass
echo ""
...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/sources.list.debian7"
...
echo 'echo -e ""' >> .bashrc
echo 'echo -e "============================================================="' >> .bashrc
echo 'echo -e "||                   Modified by: FINEx                    ||"' >> .bashrc
echo 'echo -e "============================================================="' >> .bashrc
echo 'echo -e ""' >> .bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/vps.conf"
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
iptables -t nat -I POSTROUTING -s 192.168.100.0/24 -o eth0 -j MASQUERADE
iptables-save > /etc/iptables_yg_baru_dibikin.conf
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/iptables"
chmod +x /etc/network/if-up.d/iptables
service openvpn restart

# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/client-1194.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
cp client.ovpn /home/vps/public_html/

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/badvpn-udpgw64"
fi
...
sed -i 's/DROPBEAR_PORT=443/DROPBEAR_PORT=3128/g' /etc/default/dropbear
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/squid3.conf"
...
wget https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/ddos-deflate-master.zip
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/issue.net"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/menu.sh"
wget -O usernew "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/usernew.sh"
wget -O trial "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/trial.sh"
wget -O delete "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/hapus.sh"
wget -O check "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/user-login.sh"
wget -O member "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/user-list.sh"
wget -O restart "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/resvis.sh"
wget -O speedtest "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/info.sh"
wget -O about "https://raw.githubusercontent.com/FINExx/VPNSetup-FINEx/master/about.sh"
...
echo "Modified: FINEx"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "VPS AUTO REBOOT TIME HOURS 12AM NIGHT"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "======================================================="  | tee -a log-install.txt
echo "=======================================================" | tee -a log-install.txt
