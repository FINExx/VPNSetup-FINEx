...
read -p "Password baru: " -e -i panda29 DatabasePass
echo ""
...
echo 'echo -e "Script mod by FINEx"' >> .bashrc
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels Mod by FINEx"  | tee -a log-install.txt
